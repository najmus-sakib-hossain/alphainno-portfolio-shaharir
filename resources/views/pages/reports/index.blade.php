                ...
                <table class="table align-middle table-dark table-hover mb-0">
                    <thead style="background: linear-gradient(135deg, var(--primary-color), var(--secondary-color)); color: #ffffff;">
                        <tr>
                            ...
                            <th class="text-start py-3" style="font-size: 0.875rem; font-weight: 600;">Quote</th>
                    ...
                    <tbody>
                        ...
                        <tr style="transition: background 0.2s ease;">
                            ...
                            <td class="fw-semibold text-start" style="font-size: 0.875rem; color: var(--text-primary);">{{ Str::limit($report->title, 100) }}</td>
                        ...
                        <tr>
                            <td colspan="3" class="text-center py-5" style="font-size: 0.875rem; color: var(--text-secondary);">
                                <i class="bi bi-info-circle me-1"></i> No reports found.
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
