...
<div class="pt-2 mx-2">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('events.create') }}" class="btn btn-primary add-btn rounded-pill px-4 py-2">
                ...
                <table class="table align-middle table-dark table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr style="transition: background 0.2s ease;">
                            <td class="text-center" style="font-size: 0.875rem; color: var(--text-secondary);">{{ $index + 1 }}</td>
                            <td class="text-center">
                                @if($event->hasMedia('event_image'))
                                    <div class="image-badge img-badge">
                                        <img src="{{ $event->getFirstMediaUrl('event_image') }}" alt="Event Image" class="rounded-circle" width="48" height="48">
                                    </div>
                                @else
                                    <div class="image-badge user-badge">No Image</div>
                                @endif
                            </td>
                            <td class="fw-semibold text-center" style="font-size: 0.875rem; color: var(--text-primary);">{{ $event->title }}</td>
                            <td class="text-center text-secondary text-truncate" style="max-width: 300px;">{{ $event->content ?? '—' }}</td>
                            <td class="text-center">
