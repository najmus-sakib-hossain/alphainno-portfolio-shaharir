                ...
                <table class="table align-middle table-dark table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr style="transition: background 0.2s ease;">
                            ...
                            <td class="fw-semibold text-center" style="font-size: 0.875rem; color: var(--text-primary);">{{ $certificate->title }}</td>
                            <td class="text-center">
                                @if($certificate->image)
                                    <div class="image-badge img-badge">
                                        <img src="{{ asset('storage/' . $certificate->image) }}" 
                                             alt="Certificate Image" class="rounded-circle" width="48" height="48">
                                    </div>
                                @else
                        ...
                        <tr>
                            <td colspan="5" class="text-center py-5" style="font-size: 0.875rem; color: var(--text-secondary);">
                                <i class="bi bi-info-circle me-1"></i> No certificates found.
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
