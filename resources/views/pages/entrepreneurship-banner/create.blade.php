...
@section('title', 'Add New Entrepreneurship Banner')
...
<div class="content-area">
    <div class="card card-dark">
        <div class="card-header-dark">
            <h3 class="card-title-modern">Add New Entrepreneurship Banner</h3>
        </div>
        <div class="card-body">
            @if ($errors->any())
                <div class="alert alert-danger bg-danger text-white rounded-3 p-3">
                    <ul class="mb-0 ps-3">
            ...
            <form action="{{ route('enterpreneurship-banners.store') }}" method="POST" enctype="multipart/form-data" id="bannerForm">
                ...
                <div class="form-group">
                    <label for="image" class="form-label-dark">Upload Banner Image <span class="text-danger">*</span></label>
                ...
                <div class="d-flex justify-content-center gap-3 mt-3">
                    <a href="{{ route('enterpreneurship-banners.index') }}" class="btn-modern-red"><i class="fas fa-times"></i> Cancel</a>
                    <button type="submit" class="btn-modern-green"><i class="fas fa-upload"></i> Upload Banner</button>
                </div>
            </form>
        </div>
    </div>
