                ...
                <table class="table align-middle table-dark table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr style="transition: background 0.2s ease;">
                            <td class="text-center" style="font-size: 0.875rem; color: var(--text-secondary);">{{ $story->id }}</td>
                            <td class="text-center">
                                {{-- @if($story->image_path)
                                    <div class="image-badge img-badge">
                                        <img src="{{ asset('storage/'.$story->image_path) }}" alt="Story Image" class="rounded-circle" width="48" height="48">
                                    </div>
                                @else
                            ...
                            <td class="fw-semibold text-center" style="font-size: 0.875rem; color: var(--text-primary);">{{ $story->title }}</td>
                            <td class="text-center" style="font-size: 0.875rem; color: var(--text-secondary);">{{ $story->subtitle }}</td>
                            <td class="text-center">
                                @if($story->is_active)
                        ...
                        <tr>
                            <td colspan="6" class="text-center py-5" style="font-size: 0.875rem; color: var(--text-secondary);">
                                <i class="bi bi-info-circle me-1"></i> No stories found.
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
