                ...
                <table class="table align-middle table-dark table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr style="transition: background 0.2s ease;">
                            <td class="text-center" style="font-size: 0.875rem; color: var(--text-secondary);">{{ $key + 1 }}</td>
                            <td class="fw-semibold text-center" style="font-size: 0.875rem; color: var(--text-primary);">{{ $field->title }}</td>
                            <td class="text-center" style="font-size: 0.875rem; color: var(--text-secondary);">{{ $field->tools_title }}</td>
                            <td class="text-center">
                                @if($field->image)
                                    <div class="image-badge img-badge">
                                        <img src="{{ asset('storage/' . $field->image) }}" 
                                             alt="Field Image" class="rounded-circle" width="48" height="48">
                                    </div>
                                @else
                        ...
                        <tr>
                            <td colspan="6" class="text-center py-5" style="font-size: 0.875rem; color: var(--text-secondary);">
                                <i class="bi bi-info-circle me-1"></i> No fields found.
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
