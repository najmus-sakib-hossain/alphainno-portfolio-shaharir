...
<div class="content-area">
    <div class="card card-dark">
        <div class="card-header-dark">
            <h3 class="card-title-modern">Add Technology Field</h3>
        </div>
        <div class="card-body">
            <form action="{{ route('technology.storeField') }}" method="POST" enctype="multipart/form-data" id="technologyFieldForm">
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="image-upload-container" id="mainImageUploadContainer">
                        <div class="upload-text">Drag & Drop Main Image or Click to Upload</div>
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="image-upload-container" id="frameImageUploadContainer">
                        <div class="upload-text">Drag & Drop Frame Image or Click to Upload</div>
                ...
                <div class="form-group">
                    <label for="tools_title" class="form-label-dark">Tools Title</label>
                    <input type="text" name="tools_title" id="tools_title" class="form-control-dark @error('tools_title') is-invalid @enderror" value="{{ old('tools_title') }}">
                    @error('tools_title')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    <label for="tools_description" class="form-label-dark">Tools Description</label>
                    <textarea name="tools_description" id="tools_description" class="form-control-dark @error('tools_description') is-invalid @enderror" rows="3">{{ old('tools_description') }}</textarea>
                ...
                <div class="d-flex justify-content-center gap-3">
                    <a href="{{ route('technology.index') }}" class="btn-modern-red">Back</a>
