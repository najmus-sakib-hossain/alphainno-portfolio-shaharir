...
<div class="content-area">
    <div class="card card-dark">
        <div class="card-header-dark">
            <h3 class="card-title-modern">Edit Banner</h3>
        </div>
        <div class="card-body">
            <form action="{{ route('banners.update', $banner->id) }}" method="POST" enctype="multipart/form-data" id="bannerForm">
                @csrf
                @method('PUT')

                <div class="form-group">
                    <label for="title" class="form-label-dark">Title <span class="text-danger">*</span></label>
                    <input type="text" name="title" id="title" class="form-control-dark" value="{{ $banner->title }}" required>
                </div>

                <div class="form-group">
                    <label for="subtitle" class="form-label-dark">Subtitle</label>
                    <input type="text" name="subtitle" id="subtitle" class="form-control-dark" value="{{ $banner->subtitle }}">
                </div>
                ...
                <div class="form-group mb-2">
                    ...
                    <div class="image-upload-container" id="imageUploadContainer">
                        @if($banner->image_path)
                            <img id="imagePreview" class="image-preview" src="{{ asset('storage/'.$banner->image_path) }}" style="display:block;">
                        @else
                ...
                <div class="form-group">
                    ...
                    <input type="url" name="video_url" id="video_url" class="form-control-dark" value="{{ $banner->video_url }}">
                </div>
                ...
                <div class="d-flex justify-content-center gap-3 pt-3">
                    <button type="submit" class="btn-modern-green"><i class="fas fa-save"></i> Update Banner</button>
