                ...
                <table class="table align-middle table-dark table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr style="transition: background 0.2s ease;">
                            <td class="text-center" style="font-size: 0.875rem; color: var(--text-secondary);">{{ $blog->id }}</td>
                            <td class="fw-semibold text-center" style="font-size: 0.875rem; color: var(--text-primary);">{{ $blog->title }}</td>
                            <td class="text-center" style="font-size: 0.875rem; color: var(--text-secondary); max-width: 250px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                                ...
                                @if($blog->getFirstMediaUrl('blog_cover_image'))
                                    <div class="image-badge img-badge">
                                        <img src="{{ $blog->getFirstMediaUrl('blog_cover_image') }}" 
                                             alt="Blog Image" class="rounded-circle" width="48" height="48">
                                    </div>
                                @else
                        ...
                        <tr>
                            <td colspan="5" class="text-center py-5" style="font-size: 0.875rem; color: var(--text-secondary);">
                                <i class="bi bi-info-circle me-1"></i> No blogs found.
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
...
<style>
    ...
    @media (max-width: 767.98px) {
        .title-header { font-size: 1.25rem !important; }
