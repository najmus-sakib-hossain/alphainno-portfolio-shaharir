...
<div class="content-area">
    <div class="card card-dark">
        <div class="card-header-dark">
            <h3 class="card-title-modern">Add New Innovation</h3>
        </div>
        <div class="card-body">
            <form action="{{ route('innovations.store') }}" method="POST" enctype="multipart/form-data" id="innovationForm">
                ...
                <div class="form-group">
                    ...
                    <textarea 
                        ...
                        rows="4" 
                        placeholder="Innovation content..." required>{{ old('content') }}</textarea>
                    @error('content')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    <label for="images" class="form-label-dark">Upload Images</label>
                ...
                <div class="d-flex justify-content-center gap-3">
                    <button type="submit" class="btn-modern-green"><i class="fas fa-save"></i> Save Innovation</button>
                    <a href="{{ route('innovations.index') }}" class="btn-modern-red"><i class="fas fa-times"></i> Cancel</a>
                </div>
            </form>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    input.addEventListener('change', () => {
        if(input.files.length > 0) handleImages(input.files);
    });
