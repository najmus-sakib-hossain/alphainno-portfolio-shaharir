...
<div class="content-area">
    <div class="card card-dark">
        <div class="card-header-dark">
            <h3 class="card-title-modern">Add New Award</h3>
        </div>
        <div class="card-body">
            <form action="{{ route('awards.store') }}" method="POST" enctype="multipart/form-data" id="awardForm">
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        name="time_period" 
                        id="time_period" 
                        class="form-control-dark @error('time_period') is-invalid @enderror" 
                ...
                <div class="d-flex justify-content-center gap-3">
                    <button type="submit" class="btn-modern-green"><i class="fas fa-save"></i> Save Award</button>
